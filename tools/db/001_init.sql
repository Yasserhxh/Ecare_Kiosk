...
CREATE TABLE Orders (
  ...
  DriverId UNIQUEIDENTIFIER NOT NULL REFERENCES Drivers(Id),
...
INSERT INTO Clients(Id,Name,SapOk) VALUES (@c1,'VADINA',1);

DECLARE @d1 UNIQUEIDENTIFIER = NEWID();
INSERT INTO Drivers(Id,Slv,FirstName,LastName,Plate,ClientId) VALUES
(@d1,'13210.B.7','Youssef','H.','20157.E.6',@c1);

INSERT INTO Orders (Id,Number,DriverId,ClientId,ProductId,ProductType,ProductName,Unit,Quantity,Status,CreatedAt)
