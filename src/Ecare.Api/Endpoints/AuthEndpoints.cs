...
namespace Ecare.Api.Endpoints
{
    public static class AuthEndpoints
    {
        public static IEndpointRouteBuilder MapAuthEndpoints(this IEndpointRouteBuilder app)
        {
            ...
            app.MapPost("/auth/deactivate", async (DeactivateUserCommand cmd, IMediator mediator)
                => Results.Ok(await mediator.Send(cmd)));
            ...
            app.MapGet("/auth/users", async ([AsParameters] GetAllUsersQuery query, IMediator mediator) =>
            {
